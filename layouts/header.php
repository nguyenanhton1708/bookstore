                        ...
                        <div class="col-md-3" id="header-right">
                            <div class="pull-right">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="tel:0364129272" style="color:black; outline: none">0364129272</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php foreach ($productNew as $item) { ?>
                                    <li class="clearfix">
                                        <a href="chi-tiet-san-pham.php?id=<?php echo $item['id' ] ?>">
                                            <img src="public/uploads/product/<?php echo $item['image'] ?>" class="img-responsive pull-left" width="80" height="80">
