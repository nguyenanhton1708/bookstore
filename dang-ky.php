    ...
    <section class="box-main1">
        ...
        <form action="" method="POST" style="margin-top: 20px">
		    <div class="form-group row">
		        ...
		        <div class="col-sm-10">
		            <input type="text" name="name" class="form-control" id="inputEmail3"  value="<?php echo $data['name'] ?>">
		    ...
		    <div class="form-group row">
		        ...
		        <div class="col-sm-10">
		            <input type="number" name="phone" class="form-control" id="inputPassword3"  value="<?php echo $data['phone'] ?>">
		    ...
		    <div class="form-group row">
		        ...
		        <div class="col-sm-10">
		            <input type="text" name="address" class="form-control" id="inputPassword3"  value="<?php echo $data['address'] ?>">
